...
<body style="background-color : #f77e7e;">
<?php
    include 'config.php';
...
<div class="container">
        <h2 class="text-center pt-4" style="color : #082748;">Remove Users</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="removeuserrq.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn-danger" style="border-radius:20PX;">Remove</button></a></td> 
                    </tr>
                <?php
                        $cnt=$cnt+1;
                    }
