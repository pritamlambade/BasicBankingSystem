...
<body style="background-color : #84cfa1;">
<?php
    include 'config.php';
...
?>
        ...
        <h2 class="text-center pt-4" style="color : #082748;">Create User</h2>
        <br>
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            <div class="app-form-group">
              <input class="app-form-control" placeholder="ENTER YOUR FULL NAME" type="text" name="name" required>
            </div>
            <div class="app-form-group">
              <input class="app-form-control" placeholder="VALID EMAIL ID" type="email" name="email" required>
            </div>
            <div class="app-form-group">
